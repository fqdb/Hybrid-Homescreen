...
public class CellLayout extends ViewGroup {
    ...
    private int mCellHeight = 250;
    
    private int mLongAxisStartPadding = 10;
    private int mLongAxisEndPadding = 10;

    private int mShortAxisStartPadding = 10;
    private int mShortAxisEndPadding = 10;
    ...
    public CellLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        // possible attributes for styling CellLayout
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.CellLayout, defStyle, 0);

        mShortAxisCells = a.getInt(R.styleable.CellLayout_shortAxisCells, 4);
        mLongAxisCells = a.getInt(R.styleable.CellLayout_longAxisCells, 6);
    ...
    public CellInfo getTag() {
        ...
        if (mDirtyTag && info.valid) {
            final int xCount = mShortAxisCells;
            final int yCount = mLongAxisCells;
